function init() {
    ...
    d3.json("samples.json").then((data) => {
      ...
      // First sample from the to build the initial plots
    ...
    d3.json("samples.json").then((data) => {
      ...
      var barLayout = {
        ...
        annotations: [{
          ...
          y: -0.25,
          yanchor: 'center',
          text: 'Bar chart of the top 10 OTUs found in your belly button',
          showarrow: false
        }]
      };
      //console.log("hello");
      ...
      var gaugeLayout = { 
        ...
        annotations: [{
          ...
          y: 0,
          yanchor: 'center',
          text: "Washing frequency of belly button per week",
          showarrow: false
        }]
      };
